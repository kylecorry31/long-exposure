...
def has_valid_pixels(frame, threshold, border_percentage=0.0):
    if border_percentage > 0.0:
        ...
        f = apply_threshold(
            frame[border_h : h - border_h, border_w : w - border_w], threshold
        )
    else:
