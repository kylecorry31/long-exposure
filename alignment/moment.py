...
class MomentAligner(Aligner):
    ...
    def align(self, frame):
        ...
        # Scale the current frame with the frame centroid as the pivot
        M = cv2.getRotationMatrix2D((frame_centroid_x, frame_centroid_y), 0, scale)
